$(document).ready(function(){
	...
	$('#gallery img').fadeTo(1000,1); //fadeTo(delay in miliseconds, opacity)
	
	//next I want to create a function that will only run when someone hovers over a fruit image.
	function mouseOn(){
		$(this).fadeTo(20,0.4); //the keyword 'this' refers to the element that is calling the function in our case it is the individual image that the user has their mouse over top of.
	}
